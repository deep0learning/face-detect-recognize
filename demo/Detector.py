...
class MTCNNDet(object):
    def __init__(self,min_size,threshold):
        self.test = 1
        self.load = 1
        self.load_model()
    ...
    def load_model(self):
        ...
        if load_ :
            ...
            deploy = '../models/PNet.prototxt'
            caffemodel = '../models/PNet.caffemodel'
        self.net_12 = caffe.Net(deploy,caffemodel,caffe.TEST)
        if load_:
            deploy = '../models/24net.prototxt'
            caffemodel = '../models/24net.caffemodel'
            #deploy = '../models/det2_train.prototxt'
            #deploy = '../models/rnet_caffe.prototxt'
            #caffemodel = '../models/det2_.caffemodel'
            #caffemodel = "../models/_iter_5300000.caffemodel"
        else:
            deploy = '../models/RNet.prototxt'
            caffemodel = '../models/RNet.caffemodel'
        self.net_24 = caffe.Net(deploy,caffemodel,caffe.TEST)
        if load_:
            deploy = '../models/48net.prototxt'
            caffemodel = '../models/48net.caffemodel'
            #deploy = "../models/onet.prototxt"
            #caffemodel = "../models/onet.caffemodel"
        else:
            #deploy = '../models/ONet.prototxt'
            #caffemodel = '../models/ONet.caffemodel'
            deploy = "../models/onet.prototxt"
